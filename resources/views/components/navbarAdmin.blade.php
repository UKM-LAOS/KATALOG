<nav class="h-screen flex flex-col columns-1 font-serif bg-[#39586D] w-80">
    <div class="flex flex-col items-center border w-full">
    ...
    <div class="grid grid-flow-row  font-sans text-4xl text-white font-extralight" x-data="{ activePath: window.location.pathname }">
        ...
        <div class="mt-[4rem] flex flex-col ">
            ...
            <a href="/about" :class="{ 'underline-offset-8 underline': activePath === '/about' }">about</a>
        </div>
        <div class="mt-[4rem] flex flex-col ">
            
            <a href="/services" :class="{ 'underline-offset-8 underline': activePath === '/services' }">services</a>
        </div>
        <div class="mt-[4rem] flex flex-col ">
            
            <a href="/contact" :class="{ 'underline-offset-8 underline': activePath === '/contact' }">contact</a>
        </div>
    </div>
</nav>
